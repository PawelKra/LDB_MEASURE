...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tableWidget_results = QtWidgets.QTableWidget(parent=self.groupBox)
        font = QtGui.QFont()
        font.setFamily("Monospace")
        self.tableWidget_results.setFont(font)
        self.tableWidget_results.setAutoFillBackground(False)
        self.tableWidget_results.setLocale(QtCore.QLocale(QtCore.QLocale.Language.English, QtCore.QLocale.Country.UnitedKingdom))
        ...
        self.pushButton_cancel = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.widget = MplWidget(parent=Dialog)
