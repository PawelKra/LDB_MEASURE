...
#
# MANUAL PATCH (keep after every pyuic6 regen): the six QPixmap("ikonki/...")
# calls below are wrapped in respath.resource_path() so the toolbar icons
# resolve inside a PyInstaller bundle, not just from the source tree.
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.g_sample_lineEdit = QtWidgets.QLineEdit(parent=self.groupBox)
        ...
        self.pushButton_defdir = QtWidgets.QPushButton(parent=self.groupBox)
        ...
        self.comboBox_device = QtWidgets.QComboBox(parent=self.groupBox_2)
        ...
        self.lineEdit_com = QtWidgets.QLineEdit(parent=self.groupBox_2)
        ...
        self.lineEdit_imp = QtWidgets.QLineEdit(parent=self.groupBox_2)
        ...
        self.tableWidget_headers = QtWidgets.QTableWidget(parent=self.groupBox_3)
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.g_addDefPol = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(resource_path("ikonki/editadd.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.g_addDefPol.setIcon(icon)
        self.g_addDefPol.setObjectName("g_addDefPol")
        self.verticalLayout_4.addWidget(self.g_addDefPol)
        self.g_delDefPol = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(resource_path("ikonki/editremove.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.g_delDefPol.setIcon(icon1)
        self.g_delDefPol.setObjectName("g_delDefPol")
        self.verticalLayout_4.addWidget(self.g_delDefPol)
        self.g_firstDefPol = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(resource_path("ikonki/TOP.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.g_upDefPol = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(resource_path("ikonki/UP.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.g_upDefPol.setIcon(icon3)
        self.g_upDefPol.setObjectName("g_upDefPol")
        self.verticalLayout_4.addWidget(self.g_upDefPol)
        self.g_downDefPol = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(resource_path("ikonki/DOWN.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.g_lastDefPol = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(resource_path("ikonki/LAST.png")), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
